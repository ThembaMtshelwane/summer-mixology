...
const ProductSection = () => {
  ...
  return (
    <div className="w-full h-screen pt-[100px] pb-[20px] text-[#002B49]">
      ...
      <div className="embla w-full overflow-hidden relative pt-[80px]" ref={emblaRef}>
        <div className="embla__container flex gap-10">
          {drinks.slice(0, 4).map((drink, index) => (
            <Link to={`/product/${drink.name}`} key={index}>
              <div className="h-[60vh]">
                <img src={drink.thumbnail} alt={drink.name} className="md:max-w-[500px] max-w-[300px] md:h-[50vh] h-[50vh] object-cover" />
                <div className="pt-6 text-start text-gray-600">
                  <h2 className="font-light text-lg uppercase text-gray-600">{drink.category}</h2>
